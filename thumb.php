...
class timthumb {
	...
	protected function calcDocRoot(){
		$docRoot = @"/home/thantuong/web/thantuong.tv/public_html";
		...
		if($docRoot && "/home/thantuong/web/thantuong.tv/public_html" != '/'){ $docRoot = preg_replace('/\/$/', '', $docRoot); }
