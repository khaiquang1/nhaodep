                        ...
                        <div class="panel panel-success succ-mar">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    ...
                                    @if(isset($lead) && $lead->id!="" && $lead->phone!="")
                                    <a href="https://crm.lavendervn.com/sales/create?cus={{$lead->id}}" class="poupmain" target="_blank">Tạo đơn hàng</a>
                                    @endif
                                </h4>
                            </div>
                            <div class="panel-body task-body1">
...
    <div role="main" class="ui-content">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <div class="controls">
                        {!! Form::label('function', trans('Tương tác qua'), ['class' => 'control-label required', 'placeholder' => 'Please select']) !!}
                        <div class="controls">
                            {!! Form::select('source_id', $functions, null, ['id'=>'source_id', 'class' => 'form-control select_function']) !!}
                            <span class="help-block">{{ $errors->first('function', ':message') }}</span>
                        </div>
                </div>
