    ...
    <div class="panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                ...
                {{ $title }}  | <a href="/lead/comment">KH comment</a>
            </h4>
                    ...
                    <div class="split left">
                        ...
                        <div id="userlist">
                            ...
                            @if($leadsList)
                                ...
                                @endphp
                                <div class="boxlead psid{{$listData["psid"]}}" onclick="clickChat('{{trim($listData["psid"])}}', '{{$listData["page_id"]}}', '{{$listData["id"]}}');">
                                    @if(isset($listData["read"]) && $listData["read"]==0)
                                    ...
                                    <div class="boxinfo {{$readuncheck}}">
                                        ...
                                        <span class="note">@if($listData["messengerData"]["title"]!="") {{substr(strip_tags($listData["messengerData"]["title"]),0,30)}}  @else {{substr(strip_tags($listData["messengerData"]["messenger"]),0,30)}}  @endif</span>
                                        <span class="phone">{{trim($listData["phone"])}}</span>
                                    </div>
                                </div>
                                @endforeach
                            @endif
                    ...
                    <div class="split right">
                        <div class="" id="detaillead">
                                ...
                                <div class="boxtag">
                                    ...
                                    <div class="info_viewmore infobox"><span id="clockuser">Chặn User</span></div>
                                </div>
                                <div class="boxtag">
...
<div id="myModal" class="modal">
    ...
    function filter(filter=""){
        $("#userlist").html("<div style='float:left; width:100%; text-align:center'><img src='//api.fastercrm.com/images/loadding.gif' /></div>");
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $.each($leadsListData, function (i, item) {
                        ...
                        if(item.messengerData.title!=""){
                                $itemdata+="<span class=\"note\">"+custrtring(item.messengerData.title,30)+"</span>";
                            }else{
                                $itemdata+="<span class=\"note\">"+custrtring(item.messengerData.messenger,30)+"</span>";
                            }
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        //  }
                            ...
                            if(item.messengerData.title!=""){
                                $itemdata+="<span class=\"note\">"+item.messengerData.title+"</span>";
                            }else{
                                $itemdata+="<span class=\"note\">"+item.messengerData.messenger+"</span>";
                            }
                            $itemdata+="<span class=\"phone\">"+item.phone+"</span></div></div>";
                            $('.psid'+item.psid).remove();
