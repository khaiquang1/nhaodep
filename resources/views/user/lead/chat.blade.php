...
@section('css') 
    ...
    <link rel="stylesheet" type="text/css" href="{{ URL::asset('assets/libs/admin-resources/rwd-table/rwd-table.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{ URL::asset('assets/css/icons.min.css')}}">
            ...
            <div class="col-md-2">
                 <div class="form-group required {{ $errors->has('tags') ? 'has-error' : '' }}">
                    ...
                    <div class="controls">
                        ...
                        {!! Form::select('status', $statusList, null, ['id'=>'status_list', 'class' => 'form-control select_function']) !!}
                        @endif
                    </div>
                </div>
            </div>
