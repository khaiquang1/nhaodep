                ...
                <table id="data" class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th width="120px">Chuyển đến</th>
                                <th width="120px">Khách hàng</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($listData["status"]==0) 
                                        <span style="color:orange; font-weight:bold">Chưa nhận 
                                    @elseif($listData["status"]==1)
                                        <span style="color:green; font-weight:bold">Đã nhận
                                    @else
                                        <span style="color:red; font-weight:bold">Hết hạn
                                    @endif 
                                        </span>
                                </td>
                                <td>@if($listData["status"]==0) <a class="popup-edit" href="/lead/editassign?id={{$listData['id']}}">Chuyển </a>@endif </td>
                            </tr>
                            @endforeach
                        @endif
                        </tbody>    
