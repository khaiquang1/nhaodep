            ...
            $("#invoice").bootstrapValidator({
                fields: {
                    ...
                    sales_person_id: {
                        validators: {
                            notEmpty: {
                                message: 'Phải có nhân viên phụ trách.'
                            }
                        }
                    },
                    invoice_date: {
                        validators: {
                            notEmpty: {
                                message: 'Ngày tạo hóa đơn không được rỗng'
                            }
                        }
                    },
                    invoice_deadline_date: {
                        validators: {
                            notEmpty: {
                                message: 'Ngày đến hạn thanh toán không được rỗng'
                            }
                        }
                    },
                    payment_id: {
                        validators: {
                            notEmpty: {
                                message: 'Điều khoản thanh toán bắt buộc'
                            }
                        }
                    },
                    status: {
                        validators: {
                            notEmpty: {
                                message: 'Phươnng thức thanh toán là bắt buộc.'
                            }
                        }
                    },
                    product_list: {
                        validators: {
                            notEmpty: {
                                message: 'Cần cung cấp sản phẩm/dịch vụ KH chọn.'
                            }
                        }
                    }
                }
